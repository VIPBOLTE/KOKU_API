...
Please note that you need to install `KOKUAPI` using pip by running `pip install --upgrade KOKUAPI` in your terminal before executing these codes.
...
<b>🔗 Have fun coding with KOKUAPI! </b>
